...
protected
  def create_user(options = {})
    ...
    record.vehicles.build :vehicle_model => VehicleModel.first, :year => 1995, :initial_annual_mileage => 20000
    record.vehicles.build :vehicle_model => VehicleModel.first, :year => 1994, :initial_annual_mileage => 15000
    record.save
    record
  end
end
